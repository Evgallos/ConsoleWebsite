...
const commands = {
    ...
    "/root copyrigt":"© Website Ownership & Open-Source Acknowledgment\n\nAt the top right of my website, you'll find the Solar System button. This feature is not part of my portfolio, and the code does not belong to me. I discovered it as an open-source project on GitHub by user -CogniSolver-. Inside the Solar System, you’ll find a GitHub URL linking to the original source code. I included this feature because I love astronomy and thought it would be a great personal touch. Within the Solar System page, there are two links:\n🔹One redirects back to the homepage The other leads to Wikipedia for more information about our solar system While this specific feature is open-source\n🔹The rest of my website—its design, layout, and concept—was entirely created by me.\n🔹The only other open-source integration I’ve used is the Weather API from Linux.\n🔹The Solar System project clearly states that its code is available for use, and I fully respect the rights of organizations and individuals who share their work under open-source licenses. I do not claim ownership over the HTML, JavaScript, or CSS code used for the Solar System feature.\n\n🚀🪐Enjoy the orbit, explore my website, and check out my projects!",
