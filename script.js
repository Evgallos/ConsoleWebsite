...
const commands = {
    ...
    "/root skills": "🛠️ Skills:\n\n🚀C#, .NET, MVC, Azure, SQL, HTML, CSS, Bootstrap, JavaScript, React.\n\n🔥Git, Linux.\n\n⚡WordPress, WIX, UX/UI Design.",
    "/root projects": "🚀 Projects:\n 2025:\n🔹Bio Webpage | Meta Front-End Development Certification Project\n🔹Console-Website | Portfolio Webpage\n🔹Fantastic4News\n 2024:\n🔹MaxCinema\n🔹MiniGame | Microsoft Certification Project\n🔹Todo List\n🔹Project plan a petting zoo visit | Microsoft Certification Project\n🔹Fizz Buzz Game\n🔹Dice Gaming Project\n🔹Calculator\n 2023:\n🔹GDA App UX/UI Project\n🔹Bread & Oil Website Responsive | Wix Certificate Project\n🔹My portfolio Website | Ux Portfolio\n 2022:\n🔹Tee's Shirts Website | Google UX/UI Certification Project\n🔹Zia's Pizza App | Google UX/UI Certification Project\n🔹Food Saver App & Responsive Website | Google UX/UI Certification Project\n🔹Drone Delivery Express App | Google UX/UI Certification Project\n🔹Tanks Website Wikipedia Responsive | Google UX/UI Certification Project",
...
function handleCommand(command) {
    ...
    if (command === "/root clear") {
        ...
        outputElement.innerHTML += "<br><br>";
        typeEffect(`"Error" Unknown command: "${command}". Try /root about, /root skills, /root projects, /root contact, /root cv, /root Website, /root awards, /root languages, /root copyright, /root storypart1, /root storypart2 /root clear`);
    }
}
