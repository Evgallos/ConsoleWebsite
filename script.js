...
Use the commands to navigate:\n/root about | /root skills | /root projects | /root contact | /root cv\n/root website | /root awards | /root languages | /root story | /root earth\n/root copyrigt | /root clear`;
...
function handleCommand(command) {
    ...
    if (command === "/root clear") {
        ...
        outputElement.innerHTML += "<br><br>";
        typeEffect(`"Error" Unknown command: "${command}". Try /root about, /root skills, /root projects, /root contact, /root cv, /root awards, /root languages, /root copyrigt, /root story /root clear`);
    }
}
